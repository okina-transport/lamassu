...
public class FeedProviderMapper {
    ...
    private static void mapPricingPlans(Map<String, Object> providerData, FeedProvider provider) {
    ...
    private static void mapVehicleTypes(Map<String, Object> providerData, FeedProvider provider) {
    ...
    private static void mapAuthentication(Map<String, Object> providerData, FeedProvider provider) {
    ...
    public static List<GBFSPerKmPricing> mapPerKmPricing(List<Map<String, Object>> perKmPricingList) {
    ...
    public static List<GBFSPerMinPricing> mapPerMinPricing(List<Map<String, Object>> perMinPricingList) {
    ...
    public static <T> void setIfPresent(Map<String, Object> map, String key, Consumer<Object> setter) {
